...
def collect_orphaned_vmdks(client):
    ...
    try:
        ...
        # VERBESSERTER ORPHANED VMDK SCAN:
                                                        ...
                                                        if file_path.endswith('.vmdk') and "-flat.vmdk" not in file_path:
                                                            ...
                                                            if is_orphaned:
                                                                orphaned_info = {
                                                                    ...
                                                                    'explanation': "VERIFIZIERTE VERWAISTE VMDK: Diese VMDK-Datei wurde mit mehreren Methoden überprüft und ist nicht mit einer aktiven VM verbunden."
                                                                }
                                                                orphaned_vmdks.append(orphaned_info)
                                                except Exception:
                                                    pass
