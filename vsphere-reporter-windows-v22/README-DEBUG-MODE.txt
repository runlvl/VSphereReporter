...
AKTIVIEREN DES DEBUG-MODUS UNTER WINDOWS:
----------------------------------------
1. Starten Sie die Anwendung mit der bereitgestellten Batch-Datei:
   debug_mode.bat

2. Oder starten Sie die Anwendung mit dem Debug-Parameter:
   run.bat -debug
